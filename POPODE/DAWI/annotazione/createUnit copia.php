...
//INSERT INTO `Annotator` (`Name`, `Project`, `Date`, `Annotator_idUnit`) VALUES ('Tizio', 'Hamlet', CURRENT_TIMESTAMP, '127');
$sql = "INSERT INTO `Annotator` (`Name`, `Project`, `Date`, `Annotator_idUnit`) VALUES ('Tizio', 'Hamlet', CURRENT_TIMESTAMP, '$id_unit')";
