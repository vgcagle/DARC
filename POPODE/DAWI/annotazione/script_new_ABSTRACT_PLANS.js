...
$(document).ready(function(){
   	...
   	$("#id_select_absplan").change(function(){ 	
   		...
   		var selected_plan = $("#id_select_absplan").val();
        ...
        */
        ...
        $.getJSON("get_goals.php", function(data, status){
        	...
        	$.each(data, function(i, field){
        		...
        		//cancello nome del goal corrente
...
$(document).ready(function(){
   // $("body").load(function(){
        $.getJSON("get_absplans.php", function(data, status){
...
$(document).ready(function(){	
    $("#id_select_absplan").change(function(){ 	
       ...
       // ripristinare la scrittura di mapping init e mapping end nell'interfaccia 
        	...
        	*/
            ...
            //Carico mapping_init (commentato perché viene già fatto sotto)
            /*
            if (mapping_i != null){  
                $.getJSON("get_unit.php?unit="+mapping_i, function(data, status){
                    ...
                    //$("#id_candidate_mapping").val(unit);
                        ...
                        //setto il campo a --- se manca mapping_init
                        //$("#id_candidate_mapping").prop('selectedIndex',0); 
                        //$("#id_description_mapping_unit").html("___");
                        //$("#id_campo_mapping_unit").html("___");
...
$(document).ready(function(){
    $("#id_button_delete_plan").click(function(){
		...
		$.get("delete_plan_from_repository.php?plan="+$("#id_select_absplan").val(), function(data, success){
            ...
            //Cancello il piano dalla tabella subPlan
...
function deleteAction (plan,action){
	//if (document.getElementById('check').value != "no"){
        ...
        xmlhttp.open("GET","detach_action_from_abstract_plan.php?plan="+plan+"&"+"action="+action,false);
        xmlhttp.send();	
	//}
}
