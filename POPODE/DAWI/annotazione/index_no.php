...
<input type="hidden" id="type_unit_corrente" />
...
<div id="titolo">
<!-- <center> 
<a href="../ABSTRACT_PLANS/absplan_template.php">Abstract Plans</a> | <a href="../DE_PLANS/deplan_template.php">Directly Executable Plans</a> | <a href="../index.html">Drammar annotation:</a> UNIT 
</center> -->
...
<div id="header_title">Unit <br/>

<textarea  id="id_textarea" rows="12" cols="90" style="text-align:left"></textarea>
<textarea  id="id_binding" style="background-color:yellow"  rows="12" cols="90" style="text-align:left"></textarea>
<br/><input type="button" value="bind selected text" id="id_bind"/>
</div>
...
<table style="text-align:left"> <col width="150px"><col width="30px"><col width="350px"><col width="30px"><col width="150px">
  <tr class="Testo"><td> <span>annotatore*: </span><span id="id_echo_annotatore">__________</span></td><td colspan="4"> <input type="text" id="id_annotatore" name="annotator" /> <input type="button" id="id_button_new_annotator" value="update"/> </td></tr>
  <tr class="Testo">
   ...
   <div id="previous">
    ...
    <br/>
    <p class="Testo">value at stake before</p>
    <div class="styled-select">
      <select multiple  id="id_value_atStake_before" style="width:300px" class="js-example-basic-multiple" name="select_value"></select>
      <!--<select id="mselect" class="js-example-basic-multiple" style="width:300px" multiple="multiple">-->
    </div>
    <br/>
    <p class="Testo">value in balance before</p>
    <!--<div class="styled-select">-->
    <div>
      <select multiple id="id_value_inBalance_before" style="width:300px" class="js-example-basic-multiple" name="select_value"></select>
    </div>
   ...
   <center>
    <div class="styled-select">
      <input type="radio"  name="unitchoice" id="unitchoice_units" value="onlyunits" />see only units
      <input type="radio"  name="unitchoice" id="unitchoice_refs"  value="onlyrefs" />see only reference units 
      <input type="radio"  name="unitchoice" id="unitchoice_all"  value="allunits" checked />see all
    ...
    <table style="text-align:left"><col width="30px"><col width="135px"><col width="135px"><col width="50px">
     ...
     <tr class="Testo">
      <td>reference</td>
      <td id="binding_unit_corrente">   </td>
      <td colspan="2"></td>
    -->
     </tr>
     <!--tr class="Testo">
    ...
    <select id="id_bind_reference_unit" name="select_reference_unit"></select> 
    <select id="id_order_reference_unit" name="select_order_unit"></select><input type="button" id="id_bind_reference" value="BIND TO REFERENCE" />
    <select multiple id="id_bound_units" name="select_bound_units"></select><input type="button" id="id_unbind_reference" value="unbind selected" />

    <br />
    <p class="TitoloColonnaNew">new unit (reference <input type="checkbox" value="reference" name="reference" id="reference_unit"/>)</p>
    ...
    <input type="button" id="id_button_create_unit" value="CREATE UNIT" <?php echo "onClick=\"createUnit(document.unit_header_form.create_unit.value, document.unit_header_form.print_nuova_unit.value, document.unit_header_form.annotator.value);   \"" ?>
  ...
  <td style="vertical-align:top; width:150px; max-width:150px; min-width:150px;"> <!-- " width=150px; " -->
   <div id="next">
    ...
    <br/>
    <p class="Testo">value at stake after</p>
    <div class="styled-select">
      <select multiple id="id_value_atStake_after" style="width:300px" class="js-example-basic-multiple" name="select_value"></select>
    </div>
    <br/>
    <p class="Testo">value in balance after</p>
    <div class="styled-select">
      <select multiple id="id_value_inBalance_after" style="width:300px" class="js-example-basic-multiple" name="select_value"></select>
    </div>
...
<table style="text-align:left; vertical-align:top;"> <col width="160px"><col width="150px"><col width="300px"><col width="100px">
 ...
 <!-- ############ NEW GOAL ############ --> 
   ...
   <div id="ups_select_or_create_deplan">
    ...
    <div class="styled-select">
     <select  id="id_cand_subplan" name="cand_subplan" <?php  //echo "onChange=\"getInfoActions(this.value);\""; ?> >
        <option>candidate plans</option> 
    </select> 
    <input type="button" value="+" id="id_button_addplan"/> 
     <select id="id_select_plan" name="select_plan"> <option>Select plan</option></select>
     <input type="button" value="-" id="id_button_detach_plan"/> 
     <br/> <input type="button" id="id_button_delete_plan" value="DELETE PLAN" <?php echo "" ?>/>
    </div>
  ...
  <!-- ############ NEW PLAN ############ --> 
    <p class="TitoloColonnaNew">new plan</p>
    <table style="text-align:left"><!-- col width="20%"><col width="70%"><col width="10%"-->
    ...
    <center>
     ...
     <input type="button" id="id_button_create_deplan" value="CREATE PLAN" <?php echo "" ?>/>
    </center>     
  ...
  <!-- ############ RELATIONS ############ --> 
  <!-- ############ RELATIONS ############ --> 
  <td class="TitoloColonna" style="vertical-align:top; width=100px; max-width:100px; min-width:100px; font-size:10pt">
   <div id="ups_accomplished_conflict_support">
    ...
    <br/>
    <p class="Testo">in conflict with</p>
    <div class="styled-select">
      <select multiple id="id_conflict_plan" name="select_plan" style="width:200px" class="js-example-basic-multiple"></select>
    </div>
    <br/>
    <p class="Testo">in support of</p>
    <div class="styled-select">
      <select multiple id="id_support_plan" name="select_plan" style="width:200px" class="js-example-basic-multiple">></select>
    </div>
    <br/>
    <p class="Testo">effect value at stake</p>
    <div class="styled-select">
      <select  multiple id="id_conflict_value_e" name="select_value" style="width:200px" class="js-example-basic-multiple">></select>
    </div>
    <br/>
    <p class="Testo">effect value in balance</p>
    <div class="styled-select">
      <select multiple id="id_support_value_e" name="select_value" style="width:200px" class="js-example-basic-multiple">></select>
    </div>
    <br/>
    <p class="Testo">precond value at stake</p>
    <div class="styled-select">
      <select multiple id="id_conflict_value_p" name="select_value" style="width:200px" class="js-example-basic-multiple">></select>
    </div>
    <br/>
    <p class="Testo">precond value in balance</p>
    <div class="styled-select">
      <select multiple id="id_support_value_p" name="select_value" style="width:200px" class="js-example-basic-multiple">></select>
    </div>
   </div> <!-- overflow-x -->
