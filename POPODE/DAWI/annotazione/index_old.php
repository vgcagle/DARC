...
<table style="text-align:left"> <col width="150px"><col width="30px"><col width="350px"><col width="30px"><col width="150px">
  ...
  <tr class="Testo">
   ...
   <div id="previous">
    ...
    <div class="styled-select">
      <select id="id_value_atStake_before" name="select_value"></select>
    </div>
    <br/>
    <p class="Testo">value in balance before</p>
    <div class="styled-select">
      <select id="id_value_inBalance_before" name="select_value"></select>
    </div>
  ...
  <td style="vertical-align:top; width:150px; max-width:150px; min-width:150px;"> <!-- " width=150px; " -->
   <div id="next">
    ...
    <div class="styled-select">
      <select id="id_value_atStake_after" name="select_value"></select>
    </div>
    <br/>
    <p class="Testo">value in balance after</p>
    <div class="styled-select">
      <select id="id_value_inBalance_after" name="select_value"></select>
    </div>
 ...
 <!-- ############ NEW GOAL ############ --> 
  ...
  <td class="TitoloColonna" style="vertical-align:top; width=100px; max-width:100px; min-width:100px;">
   <div id="ups_accomplished_conflict_support">
    ...
    <div class="styled-select">
      <select id="id_conflict_plan" name="select_plan"></select>
    </div>
    <br/>
    <p class="Testo">in support of</p>
    <div class="styled-select">
      <select id="id_support_plan" name="select_plan"></select>
    </div>
    <br/>
    <p class="Testo">effect value at stake</p>
    <div class="styled-select">
      <select id="id_conflict_value_e" name="select_value"></select>
    </div>
    <br/>
    <p class="Testo">effect value in balance</p>
    <div class="styled-select">
      <select id="id_support_value_e" name="select_value"></select>
    </div>
    <br/>
    <p class="Testo">precond value at stake</p>
    <div class="styled-select">
      <select id="id_conflict_value_p" name="select_value"></select>
    </div>
    <br/>
    <p class="Testo">precond value in balance</p>
    <div class="styled-select">
      <select id="id_support_value_p" name="select_value"></select>
    </div>
   </div> <!-- overflow-x -->
